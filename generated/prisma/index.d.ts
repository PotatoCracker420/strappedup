...
export namespace Prisma {
  ...
  */
  ...
  export type ContactFormOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "message" | "submitted_at", ExtArgs["result"]["contactForm"]>
  ...
  interface ContactFormFieldRefs {
    ...
    readonly submitted_at: FieldRef<"ContactForm", 'DateTime'>
  }
  ...
  export type ContactFormWhereInput = {
    ...
    submitted_at?: DateTimeFilter<"ContactForm"> | Date | string
  }
  ...
  export type ContactFormScalarWhereWithAggregatesInput = {
    ...
    submitted_at?: DateTimeWithAggregatesFilter<"ContactForm"> | Date | string
  }
